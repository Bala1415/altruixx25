            ...
            {[
              {
                ...
                description: "Experience the latest in AI, ML, blockchain, and emerging technologies through hands-on workshops and interactive sessions."
              },
              {
                icon: "👥",
                title: "Industry Experts",
                description: "Learn from renowned professionals, startup founders, and tech leaders who are shaping the future of technology."
              },
              {
                icon: "🏆",
                title: "Competitive Environment",
                description: "Challenge yourself in competitions designed to test your skills and creativity while competing for exciting prizes."
              },
              {
                icon: "🌐",
                title: "Global Networking",
                description: "Connect with like-minded individuals, potential co-founders, and industry mentors from around the world."
              },
              {
                icon: "💡",
                title: "Innovation Hub",
                description: "Transform your ideas into reality with access to resources, mentorship, and potential funding opportunities."
              },
              {
                icon: "📚",
                title: "Skill Development",
                description: "Enhance your technical and soft skills through specialized workshops, bootcamps, and masterclasses."
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
